                    ...
                    <Col lg={3} md={6}>
                        <Card className="glass-card-admin h-100 border-0 shadow-sm border-start border-4 border-primary">
                            <Card.Body>
                                ...
                                <h3 className="fw-bold mb-1">{Number(stats?.revenueToday || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })} {platformConfig?.baseCurrencyCode || 'USD'}</h3>
                    ...
                    <Col lg={3} md={6}>
                        <Card className="glass-card-admin h-100 border-0 shadow-sm border-start border-4 border-warning">
                            <Card.Body>
                                ...
                                <h3 className="fw-bold mb-1">{Number(invStats?.totalValue || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })} {platformConfig?.baseCurrencyCode || 'USD'}</h3>
                    ...
                    <Col lg={3} md={6}>
                        <Card className="glass-card-admin h-100 border-0 shadow-sm border-start border-4 border-info">
                            <Card.Body>
                                ...
                                <h3 className="fw-bold mb-1">{Number(invStats?.potentialProfit || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })} {platformConfig?.baseCurrencyCode || 'USD'}</h3>
                                        ...
                                        {topProducts.map((p, i) => (
                                            <tr key={i}>
                                                ...
                                                <td className="text-end pe-4 fw-bold text-success">
                                                    {Number(p.totalRevenue || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })} {platformConfig?.baseCurrencyCode || 'USD'}
                                                </td>
                                            </tr>
                                        ))}
                                    ...
                                    <tbody className="small">
                                        {sales.map((s) => (
                                            <tr key={s.id}>
                                                ...
                                                <td className="text-end pe-4 fw-bold text-primary">{Number(s.totalAmount || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })} {platformConfig?.baseCurrencyCode || 'USD'}</td>
                                            </tr>
                                        ))}
                                            ...
                                            <Card.Body className="p-4">
                                                ...
                                                <div className="mb-4">
                                                    <div className="d-flex justify-content-between small mb-1">
                                                        ...
                                                        <span className="fw-bold">{Number(invStats?.totalCost || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })} {platformConfig?.baseCurrencyCode || 'USD'}</span>
                                                    </div>
                                                ...
                                                <div>
                                                    <div className="d-flex justify-content-between small mb-1">
                                                        ...
                                                        <span className="fw-bold text-success">+{Number(invStats?.potentialProfit || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })} {platformConfig?.baseCurrencyCode || 'USD'}</span>
                                                    </div>
                                                    <div className="progress" style={{ height: '10px' }}>
