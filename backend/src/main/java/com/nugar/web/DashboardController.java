        ...
        public ResponseEntity<?> getDashboardSummary() {
                ...
                summary.put("pendingOrders",
                                saleRepository.countByCompanyIdAndStatus(companyId,
                                                com.nugar.domain.SaleStatus.PENDING));
                summary.put("preparingOrders",
                                saleRepository.countByCompanyIdAndStatus(companyId,
                                                com.nugar.domain.SaleStatus.PREPARING));
                summary.put("readyOrders",
                                saleRepository.countByCompanyIdAndStatus(companyId,
                                                com.nugar.domain.SaleStatus.READY_FOR_PICKUP));
                summary.put("completedOrders",
                                saleRepository.countByCompanyIdAndStatus(companyId,
                                                com.nugar.domain.SaleStatus.PAID));
                summary.put("cancelledOrders",
                                saleRepository.countByCompanyIdAndStatus(companyId,
                                                com.nugar.domain.SaleStatus.CANCELLED));
